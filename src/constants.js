...
export const formulaMasterData = [
    { code: 'AAFE70020', group: 'Frame', label: 'Frame', rate: 1.500, station: 'PF-FP', name: 'Exterior Pipe size 32*14*1.0 L 3.187 m' },
    { code: 'AAST03010', group: 'Structure', label: 'Rivet', rate: 5.017, station: 'PF-FP', name: 'EW rivet 7x19' },
    { code: 'AADZ09904', group: 'Board', label: 'SB 25mm', rate: 0.337, station: 'PF-BP (Ext-wall)', name: 'SB_25x1235x2405mm (ZCA68010101488)' },
    { code: 'AADZ09903', group: 'Board', label: 'SB 16mm', rate: 0.347, station: 'PF-BP (Ext-wall)', name: 'SB_16x1200x2400 (ZCA64610100003)' },
    { code: 'AAFZ09901', group: 'Board', label: 'SB 12mm', rate: 0.347, station: 'PF-BP (Ext-wall)', name: 'SB_12x1200x2400 _no sanding ZCA64210100003' },
    { code: 'AAFZ09902', group: 'Board', label: 'SB 12x1032', rate: 0.299, station: 'PF-BP (Ext-wall)', name: 'SB_12x1032x3240 _no SD (ZCA68010101483)' },
    { code: 'AAFZ09903', group: 'Board', label: 'SB 12 B', rate: 0.299, station: 'PF-BP (Ext-wall)', name: 'SB_12x1032x3240 _no sanding (ZCA68010101485) Grade B' },
    { code: 'DDFZ09902', group: 'Board', label: 'SB High', rate: 0.265, station: 'PF-BP (Ext-wall)', name: 'SB_12x1032x3650 _no SD (ZCA68010101487)_High Unit' },
    { code: 'AALZ09320', group: 'Board', label: 'SB 10mm', rate: 0.347, station: 'PF-BP (Ext-wall)', name: 'SB_10x1200x2400' },
    { code: 'AAHZ09900', group: 'Board', label: 'SB 8 Sand', rate: 0.294, station: 'PF-BP (Ext-wall)', name: 'SB_8x1200x2831 _sanding (ZCA68010101478)' },
    { code: 'DDHZ09900', group: 'Board', label: 'SB 8 High', rate: 0.257, station: 'PF-BP (Ext-wall)', name: 'SB_8x1200x3243_sanding (ZCA68010101486)_High Unit' },
    { code: 'AAGY0002A', group: 'Board', label: 'GB 9mm', rate: 0.493, station: 'PF-BP (Ext-wall)', name: 'GB_9x898x2264' },
    { code: 'AAGY5070A', group: 'Board', label: 'MGB 9mm', rate: 0.347, station: 'PF-BP (Ext-wall)', name: 'MGB_9x1200x2400' },
    ...
    { code: 'AATC02110', group: 'AATC', label: 'AATC02110', rate: 0.950, station: 'Kanban => PF-TP', name: 'Glue of ex panel WH C (Kendy White)' },
    { code: 'AATC02130', group: 'AATC', label: 'AATC02130', rate: 1.050, station: 'Kanban => PF-TP', name: 'PATTERN COATING' },
    { code: 'AATC02140', group: 'AATC', label: 'AATC02140', rate: 0.220, station: 'Kanban => PF-TP', name: 'SEALER #3' },
    { code: 'AATC02150', group: 'AATC', label: 'AATC02150', rate: 0.380, station: 'Kanban => PF-TP', name: 'TOP COAT S-BEIGE' },
    { code: 'AATC02160', group: 'AATC', label: 'AATC02160', rate: 0.380, station: 'Kanban => PF-TP', name: 'TOP COAT G-WHITE' },
    { code: 'AATC02170', group: 'AATC', label: 'AATC02170', rate: 0.380, station: 'Kanban => PF-TP', name: 'TOP COAT M-BROWN' },
    { code: 'AATC02180', group: 'AATC', label: 'AATC02180', rate: 0.380, station: 'Kanban => PF-TP', name: 'TOP COAT E-GREY' },
    { code: 'AATC02340', group: 'AATC', label: 'AATC02340', rate: 0.570, station: 'Kanban => PF-TP', name: 'TOP COAT PU-WHITE' }
];